        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="overflow-x-auto">
              <div class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <div class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 grid grid-cols-[250px_150px_150px_1fr_150px_150px] items-center ">
                ...
                @foreach ($allProducts as $product)
                  <div class="grid grid-cols-[250px_150px_150px_1fr_150px_150px] border-b dark:border-gray-700 p-2">
